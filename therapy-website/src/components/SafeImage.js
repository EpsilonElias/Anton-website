  ...
  useEffect(() => {
    ...
    const loadImage = async () => {
      ...
      try {
        ...
        // Strategy 1: Try to fetch the image with no-cors mode
        ...
        // If no-cors worked, we got an opaque response
        // Try to load the image directly since the server allows the request
        const img = new Image();
